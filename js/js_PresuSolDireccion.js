...
function mostrarSolPresu(){
    ...
    $.ajax({
        url: './api/v1/ComSolicitud.php?SolDE=true',
        type: "GET",
        dataType: "json",
        ...
        success: function (data) {
            ...
            $(json).each(function (index, item) {
                ...
                $('#tbodySolPresu').append('<tr>\n' +
                    ...
                    '                            <td class="centrarCont"><h4><i class="fas fa-check" type="button" style="color: royalblue" onclick="autorizarSolicitud('+NumAutorizacion+', \'DE\', \'SI\');" id="btnAut-'+ComNumSolicitud+'" name="btnAutorizar'+ComNumSolicitud+'" value="'+ComNumSolicitud+'"></i></h4></td>\n' +
                    '                            <td class="centrarCont"><h4><i class="fas fa-times" type="button" style="color: red" onclick="autorizarSolicitud('+NumAutorizacion+', \'DE\', \'NO\');" id="btnRec-'+ComNumSolicitud+'" name="btnRechazar-'+ComNumSolicitud+'" value="'+ComNumSolicitud+'"></i></h4></td>\n' +
                    '                        </tr>');
            });
        },
        error: function (data) {
