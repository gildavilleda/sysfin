...
//Procedimiento para agregar
        ...
        try {
            ...
            $stmt = $Db->Sentencia("EXEC Presu.Sp_AggCredito_Partida ?, ?, ?, ?, ?, ?");

            $stmt->bindParam(1, $_REQUEST{'DateRegistro'});
            $stmt->bindParam(2, $_REQUEST{'NumModPres'});
            $stmt->bindParam(3, $_REQUEST{'StrTipoDocumento'});
            $stmt->bindParam(4, $_REQUEST{'StrNoDocumento'});
            $stmt->bindParam(5, $_REQUEST{'DateFechaCom'});
            $stmt->bindParam(6, $_REQUEST{'NumPartid'});
