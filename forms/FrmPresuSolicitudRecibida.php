            ...
            <div class="col-sm-12" id="contAutSolPre" name="contAutPresupuesto">
                ...
                <table class="table" id="tblSolPresu">
                    ...
                    <tr>
                        ...
                        <th scope="col">Recibir Solicitud</th>
                    </tr>
                    </thead>
...
<div class="modal" id="modalPartPresu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
                ...
                <form name="formularioPartPresu" id="formPart" enctype="multipart/form-data" method="POST">
                    <div class="col-sm-4">
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select" id="sltParPres" name="sltParPres">
            ...
            <div class="modal-footer">
                <div class="row">
                    <button class="btn btn-danger btn-md" id="btnCancelar" name="botonCancelar">Cancelar</button>
...
<script type="text/javascript" src="./js/js_PresuSolicitudRecibida.js"></script>
