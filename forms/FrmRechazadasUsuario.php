  ...
  <div id="vcontent" class="container margenCard">
    <div id="InsumoEnt" class="card">
      <div class="modal-header text-center white-text gradientP">
        <h3 class="modal-title w-100 font-weight-bold">Solicitudes Rechazadas</h3>
      ...
      <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header gradientP white-text text-center">
            <h5 class="modal-title w-100 font-weight-bold" id="exampleModalLabel">SEGUIMIENTO</h5>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="input-group input-group-sm mb-sm-3 col-sm-11" hidden>
    ...
    <script type="text/javascript" src="./js/js_RechazadasUsuario.js"></script>