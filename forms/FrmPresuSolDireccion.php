...
<div id="vcontent" class="container2 margenCard">
    <div id="cardAutDire" class="card">
        <div class="modal-header text-center white-text gradientP">
            <h3 class="modal-title w-100 font-weight-bold">Autorización Dirección Ejecutiva</h3>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                    onclick="$('#cardAutDire').fadeOut();">
...
<script type="text/javascript" src="./js/js_PresuSolDireccion.js"></script>
