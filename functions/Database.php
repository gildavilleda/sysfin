...
class Database
{
    ...
    function GetData($Sql, $dbUser="", $dbPass="")
    {
        ...
        try {
            ...
            echo $ObjectJson->Json(0, 'Se produjo un error Codigo: ' . $e->getCode() . ' ' . $e->getCode($e->getMessage()) . " SQL: " . $Sql, null);
            exit(0);
        }
    ...
    function Connect($dbUser, $dbPass)
    {
        ...
        try {
            ...
            if ($e->getCode() == '20002') {
                ...
                echo $ObjectJson->Json(0, 'Error Codigo: ' . $e->getCode() . ' Mensaje: ' . $e->getCode($e->getMessage()), null);
            }
            exit(0);
        }
    }
